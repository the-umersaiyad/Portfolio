      ...
      <div className="bg-surface/50 border border-border p-6 rounded-2xl shadow-xl space-y-6">
        ...
        <form action={eventToEdit ? updateJourneyEvent : addJourneyEvent} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1.5">
            ...
            <input name="startDate" defaultValue={eventToEdit?.startDate || ""} required placeholder="e.g. Jan 2020" className="w-full bg-bg border border-border rounded-xl px-4 py-3 text-sm text-text focus:outline-none focus:border-accent transition-all" />
          </div>
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-text-secondary ml-1">End Date</label>
            <input name="endDate" defaultValue={eventToEdit?.endDate || ""} required placeholder="e.g. Present" className="w-full bg-bg border border-border rounded-xl px-4 py-3 text-sm text-text focus:outline-none focus:border-accent transition-all" />
          </div>
